...
function Ship(descr) {
    ...
    this.sprite = this.sprite || g_sprites.shipNoThrust;
...
Ship.prototype.computeSubStep = function (du) {
    ...
    if (thrust > 0 && g_sprites.ship2 !== this.sprite) {
        this.sprite = g_sprites.ship;
    } else if (g_sprites.ship2 !== this.sprite) {
        this.sprite = g_sprites.shipNoThrust;
    }
